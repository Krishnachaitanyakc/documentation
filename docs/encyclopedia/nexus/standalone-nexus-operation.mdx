...
curl -L https://github.com/temporalio/cli/releases/download/v1.7.3-standalone-nexus-operations/temporal_cli_1.7.3-standalone-nexus-operations_darwin_arm64.tar.gz | tar xz
```

```bash title="macOS (Intel)"
curl -L https://github.com/temporalio/cli/releases/download/v1.7.3-standalone-nexus-operations/temporal_cli_1.7.3-standalone-nexus-operations_darwin_amd64.tar.gz | tar xz
```

```bash title="Linux (arm64)"
curl -L https://github.com/temporalio/cli/releases/download/v1.7.3-standalone-nexus-operations/temporal_cli_1.7.3-standalone-nexus-operations_linux_arm64.tar.gz | tar xz
```

```bash title="Linux (amd64)"
curl -L https://github.com/temporalio/cli/releases/download/v1.7.3-standalone-nexus-operations/temporal_cli_1.7.3-standalone-nexus-operations_linux_amd64.tar.gz | tar xz
```
...
If you see `unknown command "nexus"` or `Standalone Nexus Operations are disabled` when running
commands, you are using the standard Temporal CLI instead of the Pre-release version above. The
standard `brew install temporal` or `brew upgrade temporal` does not include Standalone Nexus
Operation support during Pre-release.
