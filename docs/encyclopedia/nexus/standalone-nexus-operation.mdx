...
If you see `Standalone Nexus Operations are disabled` when running commands against a local dev server or a self hosted deployment, then you may not have set the dynamic config settings appropriately.
